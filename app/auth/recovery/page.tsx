    ...
    <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-lg text-center">
         ...
         {status === 'success' && action === 'accept' && (
           <div className="text-green-600">
             ...
             <button onClick={() => router.push('/auth/update-password')} className="mt-6 bg-green-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-green-700">
...
export default function RecoveryActionPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
      <Suspense fallback={<Loader2 className="w-12 h-12 animate-spin text-blue-600"/>}>
        <RecoveryContent />
      </Suspense>
    </div>
  );
